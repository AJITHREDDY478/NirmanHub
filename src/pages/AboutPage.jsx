    ...
    <div className="page-view active">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 md:py-24">
        ...
        <div className="text-center mb-12 sm:mb-14 md:mb-16">
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-slate-800 mb-3 sm:mb-4">About AR Print Lab</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center mb-16 sm:mb-18 md:mb-20">
          <div>
            ...
            <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-slate-600 leading-relaxed">
              <p>
                Founded with a vision to revolutionize online shopping, AR Print Lab has grown from a small startup to a leading e-commerce platform serving thousands of happy customers.
              </p>
              <p>
        ...
        {/* Why Choose Us */}
        <div className="mb-20">
          <h2 className="font-display text-3xl font-bold text-slate-800 text-center mb-12">Why Choose AR Print Lab?</h2>
