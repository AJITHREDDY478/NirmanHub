            ...
            <div className="bg-white rounded-3xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 font-medium mb-1">AR Print Lab Innovation Center</p>
            ...
            <div className="bg-white rounded-3xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 mb-1">
                    <span className="font-medium">General:</span> info@arprintlab.com
                  </p>
                  <p className="text-slate-600 mb-1">
                    <span className="font-medium">Custom Orders:</span> custom@arprintlab.com
                  </p>
                  <p className="text-slate-600 mb-1">
                    <span className="font-medium">Support:</span> support@arprintlab.com
                  </p>
