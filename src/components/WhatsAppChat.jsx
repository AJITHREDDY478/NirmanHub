        ...
        >
            ...
            <div className="bg-gradient-to-r from-green-500 to-green-600 px-5 py-4 md:py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg">AR Print Lab Support</h3>
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain">
              <div className="p-5 space-y-5">
                ...
                {showTyping && (
                  <div>
                    <div className="bg-slate-100 rounded-2xl rounded-tl-sm px-4 py-3 inline-flex items-center gap-1.5">
                    ...
                    <p className="text-xs text-slate-400 mt-1.5 ml-1">typing...</p>
                  </div>
                )}
                {showWelcomeMessage && (
                  <div>
